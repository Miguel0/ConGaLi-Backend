...
Board.prototype.checkValidPosition = function (x, y) {
    if (!this.boardCells[x][y]) {
        throw new Exception(
...
Board.prototype.nearbyCellsOfPosition = function (x, y) {
...
Board.prototype.forEachCell = function (aParticularFunction) {
...
Board.prototype.calculatePossibleDeadCellsPositions = function () {
 ...
 */
Board.prototype.averageRGB = function (arrayOfColours) {
...
Board.prototype.createCellBy = function (user, x, y) {
    this.addCell(new ContextUnawareCell(), x, y)
}

Board.prototype.killCellBy = function (user, x, y) {
    this.removeCell(x, y)
}

Board.prototype.automaticallyCreateNewCells = function () {
...
Board.prototype.stablishCellsNewGeneration = function () {
...
Board.prototype.toJSONObject = function () {
    let json = {}
